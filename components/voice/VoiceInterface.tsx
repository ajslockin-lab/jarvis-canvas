    ...
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#050A10]/95 p-6 backdrop-blur-xl">
      ...
      <div className="relative z-10 flex w-full max-w-2xl flex-1 flex-col items-center justify-center">
        <div className="hud-section-header mb-4 w-full">
          <span className="font-orbitron text-[10px] tracking-[0.2em] text-[#7d99aa]">
            VOICE INTERFACE
          </span>
        </div>
        ...
        <button
          ...
          className={`
            arc-reactor-btn flex h-28 w-28 touch-none items-center justify-center transition-all duration-300
            ${isListening ? "!border-[#FF9500]/50 !bg-[#FF9500]/10 shadow-[0_0_40px_rgba(255,149,0,0.22)]" : ""}
            ${isLoading || !speechSupported ? "!border-[#5a7a8a]/30 !bg-[#0A1520]/50 opacity-70" : ""}
          `}
        >
        ...
        {transcript && (
          <div className="mt-8 w-full">
            <p className="font-orbitron mb-2 text-[10px] tracking-[0.2em] text-[#7d99aa]">
              INPUT
            </p>
        ...
        {response && (
          <div className="mt-4 w-full">
            <p className="font-orbitron mb-2 text-[10px] tracking-[0.2em] text-[#00B4FF]">
              JARVIS
            </p>
