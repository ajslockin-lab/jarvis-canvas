...
--
-- IF NOT EXISTS on every CREATE / ADD because 0000_init already declared
-- all of this on fresh DBs. Older DBs (pre-init) still pick up the column.

ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "password_hash" text;
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "email_verified_at" timestamp;
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "auth_provider" text NOT NULL DEFAULT 'canvas';
